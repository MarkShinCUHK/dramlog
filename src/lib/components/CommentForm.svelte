...
{:else}
  <div class="rounded-xl bg-white/60 backdrop-blur-sm p-8 text-center ring-1 ring-black/5 shadow-sm">
    <p class="text-gray-700 mb-4">댓글을 작성하려면 로그인이 필요합니다.</p>
    <a
      href="/login"
      class="inline-flex items-center justify-center px-6 py-2.5 bg-whiskey-600 text-white rounded-lg hover:bg-whiskey-700 transition-colors font-medium shadow-sm hover:shadow-md"
    >
      로그인하기
    </a>
  </div>
